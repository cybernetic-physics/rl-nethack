    ...
    *,
    ...
    return {
        ...
        "teacher_policy": {
            ...
            "residual_logit_cap": config.appo.teacher_policy_residual_logit_cap,
        ...
        "replay_source": {
            ...
            "confusion_pair_boosts": config.appo.teacher_replay_confusion_pair_boosts,
            "confusion_pair_start_env_steps": config.appo.teacher_replay_confusion_pair_start_env_steps,
